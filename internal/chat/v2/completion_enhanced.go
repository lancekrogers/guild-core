...
func (ce *CompletionEngineEnhanced) GetDirectSuggestions(ctx context.Context, input string) ([]common.CompletionResult, error) {
...
func (ce *CompletionEngineEnhanced) Complete(input string, cursorPos int) []common.CompletionResult {
