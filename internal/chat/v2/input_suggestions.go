...
func (ism *InputSuggestionManager) ProcessSuggestionRequest(input string) tea.Cmd {
	...
	return func() tea.Msg {
		...
		return CompletionResultMsg{
			Results:   []common.CompletionResult{},
			ForInput:  input,
			Timestamp: time.Now(),
		}
	}
...
func (ism *InputSuggestionManager) enhanceCompletionResults(results []common.CompletionResult, input string) []common.CompletionResult {
	enhanced := make([]common.CompletionResult, 0, len(results))
...
func (ism *InputSuggestionManager) sortByRelevance(results []common.CompletionResult) {
...
func (ism *InputSuggestionManager) compareRelevance(a, b common.CompletionResult) int {
