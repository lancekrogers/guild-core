...
func (e *LSPAwareExecutor) ExecuteWithContext(ctx context.Context, task core.Task) (core.TaskResult, error) {
	...
	// Convert core.Task to kanban.Task for the base executor
	...
	// Convert ExecutionResult to core.TaskResult
...
func (e *LSPAwareExecutor) isCodeRelatedTask(task core.Task) bool {
	// Check tool name
	codeTools := []string{
...
func (e *LSPAwareExecutor) enhanceTaskWithLSP(ctx context.Context, task core.Task) (core.Task, error) {
	logger := observability.GetLogger(ctx)
...
func (e *LSPAwareExecutor) extractFileInfo(task core.Task) fileInfo {
	info := fileInfo{}
...
func (e *LSPAwareExecutor) SelectTool(ctx context.Context, task core.Task) (tools.Tool, error) {
...
func (e *LSPAwareExecutor) shouldUseLSPTool(ctx context.Context, task core.Task) bool {
