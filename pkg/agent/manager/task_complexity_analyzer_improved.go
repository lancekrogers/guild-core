...
// ImprovedTaskComplexityAnalyzer analyzes task complexity with proper error handling,
// validation, observability, and registry integration
type ImprovedTaskComplexityAnalyzer struct {
...
// NewImprovedTaskComplexityAnalyzer creates a properly configured analyzer
func NewImprovedTaskComplexityAnalyzer(
	promptManager prompts.LayeredManager,
	artisanClient ArtisanClient,
	agentRegistry registry.AgentRegistry,
	logger *slog.Logger,
) *ImprovedTaskComplexityAnalyzer {
	if logger == nil {
		logger = slog.Default()
	}
	
	return &ImprovedTaskComplexityAnalyzer{
...
func (tca *ImprovedTaskComplexityAnalyzer) AnalyzeComplexity(
	ctx context.Context,
...
func (tca *ImprovedTaskComplexityAnalyzer) validateRequest(request ComplexityAnalysisRequest) error {
...
func (tca *ImprovedTaskComplexityAnalyzer) getAvailableAgentsFromRegistry(ctx context.Context) ([]AgentInfo, error) {
...
func (tca *ImprovedTaskComplexityAnalyzer) getDefaultAgents() []AgentInfo {
	return []AgentInfo{
		{
...
func (tca *ImprovedTaskComplexityAnalyzer) buildPromptContext(
	request ComplexityAnalysisRequest,
...
func (tca *ImprovedTaskComplexityAnalyzer) buildLayeredPrompt(
	ctx context.Context,
	request ComplexityAnalysisRequest,
...
func (tca *ImprovedTaskComplexityAnalyzer) executeAnalysis(
	ctx context.Context,
...
func (tca *ImprovedTaskComplexityAnalyzer) parseAnalysisResponse(response *ArtisanResponse) (*ComplexityAnalysisResult, error) {
	if response == nil {
